        ...
        return (
            <div className="card mt-3">
                ...
                <div className="card-body">
                    ...
                    <Link type="button" className="btn btn-success mr-sm-2" to='/Ventas' >Cerrar</Link>
                    <button type="button" className="btn btn-success" onClick={this.onSubmit}>Guardar</button>
